 ...
 */
public class DoubleKeyHashMap extends OrderedHashMap {
	// so as to clear warnings ...
	static final long serialVersionUID = 0;
	// internal
	private final OrderedHashMap doublekeys = new OrderedHashMap();

	public DoubleKeyHashMap() { super(); }
	...
	public Object get(Object key) {
		...
		if(o == null) o = super.get(doublekeys.get(key));
		return o;
	}
}