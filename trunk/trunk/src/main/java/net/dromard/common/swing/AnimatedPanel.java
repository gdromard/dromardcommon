...
/**
 * Display an animated panel. 
 * The animation is based on image highlightment.
 * 
 * @author Romain Guy
 */
public class AnimatedPanel extends JPanel {
	private static final long serialVersionUID = 6672981424800387008L;
    ...
    public void paintComponent(Graphics g) {
        ...
        if (convolvedImage != null) {
            ...
            synchronized (convolvedImage) {
                ...
                layout.draw(g2, (float) (width - bounds.getWidth()) / 2, (float) (y + convolvedImage.getHeight(null) + bounds.getHeight() + layout.getAscent()));
            }
        }
    }
