...
public class WaveButtonUI extends MetalButtonUI {

    private static final WaveButtonUI INSTANCE = new WaveButtonUI();
            ...
            if (b.isContentAreaFilled()) {
                ...
                if (!b.getModel().isArmed() && !b.getModel().isPressed()) {
	                ...
	                if (b.getModel().isEnabled()) {
	                    p = new GradientPaint(0, 0, new Color(162, 234, 41), 0, height, new Color(220, 255, 124));
	                    g2.setPaint(p);
	                } else {
	                ...
	                if (b.getModel().isEnabled()) {
	                    p = new GradientPaint(0, 0, new Color(165, 207, 118), 0, height, new Color(193, 232, 145));
	                    g2.setPaint(p);
	                } else {
	...
	private static class WaveButtonBorder extends AbstractBorder implements UIResource {
		private static final long serialVersionUID = 9039840268820398392L;
